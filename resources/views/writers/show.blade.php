...
<div class="container" style="direction: rtl;text-align: right;font-family: IRANSans; margin-bottom: 10px;margin-top: 10px;text-align: right;direction: rtl">
    <div class="card">
        <h2 class="card-header" style="background-color: #14bf98;color: white;font-family: IRANSans; text-align: right">{{$writer->name}}</h2>
        <div class="row">
            <div class="col-lg-8">
                <div class="card-body">
                    <h5 class="card-title"> ملیت : {{$writer->nationality}} </h5>
                    <p class="card-text text-justify">{{$writer->description}}</p>
                </div>
            </div>
            <div class="col-lg-4">
