...
<div class="page-section bg-light" style="font-family: IRANSans">
    <div class="container">
        <h1 class="text-center wow fadeInUp">مترجمان</h1>
        <div class="row mt-5">
            @foreach($translators as $translator)
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-doctor">
                        <div class="header">
                            <a href="{{route('writers.show',$translator->id)}}" class="post-thumb">
                                <img src="{{asset($translator->profile)}}" alt="">
                            </a>
                        </div>
                        <div class="body" style="text-align: right;direction: rtl">
                            <h5 class="post-title"><a href="{{route('writers.show',$translator->id)}}">{{$translator->name}}</a></h5>
                        </div>
                    </div>
                </div>
            @endforeach
...
<div class="page-section bg-light" style="font-family: IRANSans">
    <div class="container">
        <h1 class="text-center wow fadeInUp">انتشارات</h1>
        <div class="row mt-5">
            @foreach($publishers as $publisher)
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-doctor">
                        <div class="body" style="text-align: center;direction: rtl">
                            <h5 class="post-title"><a href="{{route('publishers.show',$publisher->id)}}">{{$publisher->name}}</a></h5>
                            <div class="site-info">
                            </div>
                        </div>
                    </div>
