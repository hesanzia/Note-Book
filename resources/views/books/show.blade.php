...
<div class="container" style="direction: rtl;text-align: right;font-family: IRANSans; margin-bottom: 10px;margin-top: 10px;text-align: right;direction: rtl">
    <div class="card">
        <h2 class="card-header" style="background-color: #14bf98;color: white;font-family: IRANSans; text-align: right">{{$book->name}}</h2>
        <div class="row">
            <div class="col-lg-8">
                <div class="card-body">
                    <h5 class="card-title"> جلد : {{$book->volume}} </h5>
                    <h5 class="card-title"> زبان : {{$book->language}} </h5>
                    <a class="btn btn-primary" href="{{$book->link}}">دانلود</a>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <div class="row" style="margin-top: 10px">
        <div class="col-lg-12" style="text-align: center">
            <h2 style="font-family: IRANSans">نویسنده</h2>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-lg-4 py-2 wow zoomIn">
            <div class="card-doctor">
                <div class="header">
                    <a href="{{route('writers.show',$book->writer()->id)}}" class="post-thumb">
                        <img src="{{asset($book->writer()->profile)}}" alt="">
                    </a>
                </div>
                <div class="body" style="text-align: right;direction: rtl">
                    <h5 class="post-title"><a href="{{route('writers.show',$book->writer()->id)}}">{{$book->writer()->name}}</a></h5>
                    <div class="site-info">
                        <div class="avatar mr-2">
                            <span>{{$book->writer()->nationality}}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row" style="margin-top: 10px">
        <div class="col-lg-12" style="text-align: center">
            <h2 style="font-family: IRANSans">مترجم</h2>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-lg-4 py-2 wow zoomIn">
            <div class="card-doctor">
                <div class="header">
                    <a href="{{route('translators.show',$book->translator()->id)}}" class="post-thumb">
                        <img src="{{asset($book->translator()->profile)}}" alt="">
                    </a>
                </div>
                <div class="body" style="text-align: right;direction: rtl">
                    <h5 class="post-title"><a href="{{route('translators.show',$book->translator()->id)}}">{{$book->translator()->name}}</a></h5>
